        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CoinTransactions_Profiles_ReceiverProfileId",
                        column: x => x.ReceiverProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoinTransactions_Profiles_SenderProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostCommentLikes_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoinTransactions_ReceiverProfileId",
                table: "CoinTransactions",
                column: "ReceiverProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CoinTransactions_SenderProfileId",
                table: "CoinTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostCommentLikes_ProfileId",
                table: "PostCommentLikes",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_ReplyToCommentId",
                table: "PostComments",
